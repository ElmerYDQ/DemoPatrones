    ...
    <body style="text-align: center">
        ...
        <form action="${pageContext.request.contextPath}/ServletRuta" method="post">
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control col-sm-8" name="nombre" value="${ruta.nombre}">
            </div>
            <div class="form-group row">
                <h5 class="col-sm-2 col-form-label">Paradero inicial:</h5>
                <input type="text" class="form-control col-sm-8" name="paradero" value="${facade.getNombreParadero(ruta.paraderoInicio)}" readonly>
            </div>
            <div class="form-group row">
                <h5 class="col-sm-2 col-form-label">Paradero final:</h5>
                <input type="text" class="form-control col-sm-8" name="paradero" value="${facade.getNombreParadero(ruta.paraderoFinal)}" readonly>
            </div>
